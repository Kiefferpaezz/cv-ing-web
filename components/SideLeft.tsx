...
const SideLeft = ({ name, profesion, photo, alt }: SideLeftProps) => {
    ...
    return (
        <aside className="fixed top-0 left-0 w-[310px] h-full bg-white p-6" >
            <section className='flex flex-col mx-auto w-4/5 gap-3'>
            ...
            <section className='flex flex-col '>
                ...
                <InfoData text='Github:' val='github.com/Kiefferpaezz' />
            </section>
            <Line />
            ...
            <section className='flex flex-col gap-2'>
                ...
                <div>
                    <Porcentajes porcentaje={40} label='Python' />
                </div>
            </section>
            <Line />
            <section className='flex flex-col gap-2'>
                ...
                <div className='flex flex-col'>
                    ...
                    <ItemIcon Icon={AiOutlineBlock} label='Adaptabilidad' />
                </div>
            </section>
            <Line />
        </aside >
